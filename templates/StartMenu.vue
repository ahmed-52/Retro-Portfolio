...
<div class="menu" style="z-index: 1000000">
    ...
    <div class="socials">
        <a href="https://www.instagram.com/ahmed.veo/" target="_blank">
            <div class="bar">
                <img class="social-image" src="@/assets/iPhone-Icons/Instagram.webp" />
                <div class="social-text"><u>I</u>nstagram</div>
            </div>
        </a>
        <a href="https://www.linkedin.com/in/ahmed-abdulla-1aa908253/" target="_blank">
            <div class="bar">
                <img class="social-image" src="@/assets/iPhone-Icons/Linkedin.webp" />
                <u>L</u>inkedIn
            </div>
        </a>
        <a href="https://github.com/ahmed-52" target="_blank">
            <div class="bar">

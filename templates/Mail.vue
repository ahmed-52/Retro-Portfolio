...
<div :id="window.windowId" :style="style" class="window window-style" :class="{
    ...
    <form @submit="sendEmail" action="https://docs.google.com/forms/u/0/d/e/1FAIpQLSfv0egv-apesrQqFIsRv9t7LUefm1d7oLeGkGqRtKlE7EJ6fQ/formResponse" class="window-style" id="container" target="hidden_iframe">
        ...
        <div class="content">
            <div class="container-details">
                ...
                <div class="subject-container">
                    ...
                    <div class="receipient">Ahmed</div>
                </div>
                <hr />
                <div class="subject-container">
                    <p style="margin: 8px">Subject:</p>
                    <input name="entry.1998648830" class="subject" v-model="mailSubject" v-on:input="onChangeMailSubject" type="text" required="true" />
                </div>
                <hr />
                <div class="from-container" style="margin-bottom: 2px">
                    <p style="margin: 8px">From:</p>
                    <input name="entry.1132451825" class="subject" v-model="mailSender" v-on:input="onChangeMailSender" type="email" required="true" />
                </div>
            </div>

            <textarea name="entry.336463768" v-model="mailContent" v-on:input="onChangeMailContent" required="true"></textarea>
        </div>
    </form>
</div>
</template>
